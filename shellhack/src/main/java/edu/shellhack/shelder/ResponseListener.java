...
public class ResponseListener extends ListenerAdapter {
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            JDA jda = new JDABuilder(AccountType.BOT)
                    .setToken("MzYzNTk4ODM3NDg4NjgwOTYx.DLDkZQ.pQd7kFU3lTKnEwG5UrK50MmIOsg")           //The token of the account that is logging in.
                    .addEventListener(new ResponseListener())  //An instance of a class that will handle events.
    ...
    public void onMessageReceived(MessageReceivedEvent event)
    {
        ...
        if (msg.equals("!ping"))
        {
            ...
            String tests = "Hello world dfsdf";
            String resultArr[] = tests.split(" ");
            
            System.out.println(resultArr[0]+":"+resultArr[1]+":"+resultArr[2]);
        }
        
//        else if msg.equals(arg0)
